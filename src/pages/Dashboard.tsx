...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-[#050505] font-sans selection:bg-blue-200 antialiased pb-32">
        ...
        <div className="container max-w-[1600px] px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-6">
             ...
             <div className="hidden lg:flex items-center bg-neutral-100 dark:bg-neutral-900 rounded-2xl px-4 py-2 border border-transparent focus-within:border-blue-500/50 transition-all w-96">
                ...
                <span className="text-[10px] font-black text-neutral-400 bg-card dark:bg-black px-1.5 py-0.5 rounded shadow-sm">⌘K</span>
             </div>
          </div>

          <div className="flex items-center gap-4">
             <div className="flex items-center gap-1 bg-card dark:bg-neutral-900 p-1 rounded-2xl border border-border dark:border-neutral-800 shadow-sm">
                ...
                <button className="px-4 py-2 text-[10px] font-black uppercase tracking-widest text-neutral-400 hover:text-foreground transition-colors">Analytics</button>
                <button className="px-4 py-2 text-[10px] font-black uppercase tracking-widest text-neutral-400 hover:text-foreground transition-colors">Bay View</button>
             </div>
             <div className="w-11 h-11 bg-card dark:bg-neutral-900 border border-border dark:border-neutral-800 rounded-2xl flex items-center justify-center relative hover:shadow-lg transition-all cursor-pointer">
      ...
      <main className="container max-w-[1600px] px-6 py-10 space-y-10">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
           {[
             ...
             <Card key={i} className="group border-none shadow-xl shadow-black/5 bg-card dark:bg-neutral-900 p-8 rounded-[36px] overflow-hidden relative border-b-4 border-transparent hover:border-blue-600 transition-all duration-500">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
           ...
           <div className="lg:col-span-8 space-y-8">
              <div className="flex items-end justify-between px-2">
                 ...
                 <div className="flex items-center gap-3">
                    <Button variant="outline" className="rounded-2xl h-12 px-6 font-black text-[10px] uppercase tracking-widest border-border hover:border-neutral-900">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 {[1, 2, 3, 4].map(idx => (
                   <Card key={idx} className="border-none shadow-xl shadow-black/5 bg-card dark:bg-neutral-900 rounded-[32px] overflow-hidden group">
                      <div className="p-8">
                         <div className="flex items-start justify-between mb-8">
                            <div className="flex items-center gap-4">
                               <div className="w-14 h-14 bg-card dark:bg-neutral-800 rounded-2xl flex flex-col items-center justify-center font-black italic text-neutral-400 group-hover:bg-blue-600 group-hover:text-white transition-all duration-500 shadow-sm border border-border">
                         ...
                         <div className="space-y-6">
                            <div className="p-5 bg-card dark:bg-neutral-800 rounded-[24px] border border-border dark:border-neutral-700">
                            ...
                            <div className="flex items-center justify-between gap-4">
                               <Button variant="outline" className="flex-1 rounded-2xl py-6 font-black text-[9px] uppercase tracking-widest border-border hover:border-neutral-900">
                                  Report
                               </Button>
              ...
              <div className="space-y-6">
                 ...
                 <Card className="border-none shadow-2xl shadow-blue-900/5 bg-gradient-to-br from-blue-700 to-indigo-900 text-white p-8 rounded-[40px] overflow-hidden relative">
                    ...
                    <div className="flex gap-3">
                       <div className="flex-1 p-4 bg-card/10 backdrop-blur-md rounded-3xl border border-white/5">
                 ...
                 <Card className="border-none shadow-xl shadow-black/5 bg-card dark:bg-neutral-900 rounded-[40px] p-8">
                    <h4 className="text-lg font-black tracking-tighter uppercase italic mb-8">Recent Activity</h4>
                    <div className="space-y-8 relative before:absolute before:inset-0 before:left-3 before:border-l before:border-border dark:before:border-neutral-800 before:top-4 before:bottom-4">
                       {[
